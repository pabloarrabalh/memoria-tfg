...
\subsubsection{9.2.1 Serializers}
...
\textbf{Solución:} Se implementó una lógica de integridad en el componente \texttt{apps.py} (explicada en el punto 9.4). El sistema ahora realiza una auditoría de persistencia 
