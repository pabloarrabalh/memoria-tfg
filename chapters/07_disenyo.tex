...
\subsubsection{7.1.2 Punto de entrada: \textit{Nginx}}
 
\textit{Nginx} se configura como el punto de entrada principal al servidor, actuando como intermediario
...
En este sentido, \textit{Nginx} funciona como un proxy inverso, recibiendo las solicitudes y
