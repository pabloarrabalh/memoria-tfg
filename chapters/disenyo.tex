...
\subsubsection*{7.2.4.1. Enriquecimiento con roles}
...
\subsubsection*{7.2.4.2 Variables temporales}
...
La integración de las cuotas de mercado resultó ser una decisión de diseño fundamental; 
en las fases iniciales del proyecto, cuando no se incluían estas variables, los resultados
 predictivos eran significativamente más pobres.
 
 Estas cuotas, transformadas en probabilidades 
 implícitas de victoria y de goles en contra, aportan una estimación del «sentimiento del mercado»
  previa al partido, enriqueciendo el modelo con información externa de alto valor que los datos
   puramente históricos no lograban capturar por sí solos. Estos datos se descargan desde: \
   href{https://www.football-data.co.uk/spainm.php}{https://\linebreak www.football-data.co.uk/spainm.php}
\subsection*{7.2.5 Prevención del data leakage}
En predicción deportiva, es común cometer el error de usar datos del futuro
para predecir el pasado y dicho error ocurrió al inicio del proyecto. Para evitarlo, el sistema implementa tres
salvaguardas:
...
especializadas ya explicada en el apéndice de Stack Tecnológico. Cada una de ellas desempeña un papel fundamental en la gestión,
...
\subsubsection*{7.10.1 Ecosistema de contenedores y rsponsabilidades}
...
\end{figure}
\subsubsection*{7.10.2 Estrategia de costrucción}
...
Se han definido dos entornos diferenciados para cubrir del
desarrollo:
