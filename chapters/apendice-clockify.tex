...
Este apéndice contiene el detalle de todas las entradas registradas en Clockify durante el desarrollo del proyecto.

\subsection*{Descripción}

Clocky es la herramienta de monitorización de tiempo utilizada para registrar todas las horas invertidas en el proyecto. Los registros incluyen:
