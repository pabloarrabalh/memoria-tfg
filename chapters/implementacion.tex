...
El archivo \texttt{menu.py} actúa como el coordinador de la vista de inicio. Aunque se implementó una
...
nombre del jugador en el HTML; el sistema lo detecta y limpia mediante expresiones regulares a través del módulo commons.py.
\end{itemize}
...
Uno de los mayores retos al trabajar con modelos de Machine Learning complejoses su opacidad, 
