...
\subsection*{4.1 Alcance detallado}
...
\subsection*{4.2 Fuera de alcance}
...
\subsection*{4.3 Suposiciones, dependencias y restricciones}
...
\subsubsection*{4.4.1 Usuario anónimo (Visitante)}
...
\subsubsection*{4.4.2 Usuario registrado (Mánager)}
...
\subsection*{4.5 Requisitos Funcionales}
...
necesidad. Las historias de usuario se presentan en tablas de 3 columnas: ID (10\%), Descripción (45\%) e Historia/Criterios (45\%), con el ID ocupando toda la altura de la tabla.
...
{\textbf{Actor:} Usuario registrado\\ \textbf{Auth:} Sí\\ \textbf{Prioridad:} Must Have}
{CA9.1. Muestra puntos predichos con margen de incertidumbre.\\ CA9.2. Permite seleccionar jornada desde la interfaz.\\ CA9.3. Informa motivo si no hay predicción.\\ CA9.4. Muestra proyección total de plantilla.}
...
\subsection*{4.6 Requisitos no funcionales}

\paragraph*{RNF1. Rendimiento y tiempos de respuesta}
~\\
RNF1.1: Consultas estándar en $<$ 500 ms (95\% de las peticiones). \\
RNF1.2: Predicción/XAI en $<$ 2 s con modelo precargado (95\%).
...
\subsection*{4.8 Prototipado de UI}
