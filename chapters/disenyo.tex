...
\subsubsection{7.2.2 Conciliación de entidades}
...
\subsubsection{7.2.3 Limpieza y normalización de datos}
...
\subsubsection{7.2.4 Ingeniería de características}
...
\subsubsection{7.2.5 Prevención del data leakage}
...
\subsubsection{7.3.2 Métricas de evaluación del modelo}
...
\subsubsection{7.5.1 Modelado conceptual}
...
\subsubsection{7.5.3 Modelo lógico}
...
\subsubsection{7.8.3 Flujos de profundización}
