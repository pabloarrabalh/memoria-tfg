...
Estos resultados reflejan un comportamiento adecuado en un entorno de desarrollo local, donde ya se han aplicado mecanismos de
 optimización como el uso de caché mediante Redis. No obstante, para un despliegue real en producción será
  necesario escalar la infraestructura para soportar mayores niveles de concurrencia y reducir la latencia.
   En este sentido, la migración a un entorno cloud como Azure, permitirá
    aprovechar recursos gestionados y una mejor configuración del sistema, por lo que se espera una mejora significativa 
...
\paragraph{6. Alta penalización de características}
