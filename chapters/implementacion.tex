...
Cuando el nombre es un único token (ej. ``Mbappé'', ``Ronaldo'', ``Messi'') y no tiene un apellido crítico.
...
está en Fantasy y FBRef trae ``Ronald Araújo'', el algoritmo lo detecta como match prefijo/sufijo con un score moderadamente alto (85).
