...
\begin{itemize}
  ...
  (``Top 3''), asistente de gestión (vender/fichar) y panel de análisis del próximo rival.
...
{CA12.1. Permite seleccionar jugador para análisis.\\ CA12.2. Recomienda acción (vender/fichar).\\ CA12.3. Incluye comparativa y explicación completa.}

\RFTable{RF13}
{Histórico de predicciones}
{\textbf{Como:} Usuario registrado\\ \textbf{Quiero:} Revisar predicciones pasadas\\ \textbf{Para:} Medir la fiabilidad del sistema}
{\textbf{Actor:} Usuario registrado\\ \textbf{Auth:} Sí\\ \textbf{Prioridad:} Could Have}
{CA13.1. Incluye tabla predicho vs real.\\}
...
\caption{Casos de uso para Usuario Anónimo.}\label{fig:cu-anonimo}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=1\textwidth]{images/cu-registrado.png}
\caption{CCasos de uso para Usuario Registrado.}\label{fig:cu-registrado}
\end{figure}
...
{A1. El usuario navega a una jornada en el futuro, en dicho caso, se le informa que no hay clasificación disponible dado que es el futuro.}
